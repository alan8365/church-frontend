      ...
      > 
        <div class="setting">
          <div class="search" id="sear_db">
            <a><a-icon type="environment" style="margin-right: 3px"/>新增主日奉獻</a>
          </div>
        </div>
        <div class="box_content">
          <div class="box_content_top">
            <div class="bar">
              <i>*</i><a>家號：</a>
              <!-- <a-input class="inputBox" v-model="home_number"/> -->
...
export default {
  ...
  methods: {
    ...sundayDedication.mapActions({
      // 新增主日奉獻
      getAddRegularDonations: 'getAddRegularDonations',
    }),
