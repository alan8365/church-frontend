      ...
      >
        <div class="setting">
          <div class="search" id="sear_db">
            <a><a-icon type="environment" style="margin-right: 3px"/>編輯堅振資料</a>
          </div>
          <div class="userNum">
            最後更新時間： {{ updated_at }}
          </div>
        ...
        <div class="box_content">
          <div class="box_content_top">
            <div class="box_content_left">
                <!-- <div class="bar">
                    <a>堅振編號：</a>
                    <a-input class="inputBox" placeholder="堅振編號" v-model="userNum" disabled/>
                </div>
                <div class="bar">
                    <i>*</i><a>家號：</a>
            ...
            <div class="box_content_right">
               <div class="bar">
                    <i>*</i><a>堅振日期：</a>
                    <a-date-picker @change="onChangeConfirmationDate" placeholder="請選擇堅振日期" v-model="confirmed_at"/>
...
export default {
  ...
  methods: {
    ...
    ...confirmation.mapActions({
      // 儲存堅振資料
      getSaveConfirmationmData: 'getSaveConfirmationmData',
    }),
    // 上一頁
    forwardup() {
    ...
    checkLSEditData() {
      ...
      if (data !== null && data !== undefined) {
        ...
        this.confirmed_location = JSON.parse(localStorage.getItem("editData")).confirmed_location
        ...
        this.confirmed_at = JSON.parse(localStorage.getItem("editData")).confirmed_at
    ...
    // 儲存堅振資料
    addUser() {
      if (this.parishioners == "" || this.christian_name == "" || this.confirmed_location == "" || this.presbyter == "" || this.confirmed_at == "" || (this.godfather == "" && this.godmother == "")) {
        Modal.warning({
          title: '系統提示',
          content: `請檢查所輸入的資料內容`,
          okText: '確認',
