      ...
      >
        <div class="setting">
          <div class="search" id="sear_db">
            <a><a-icon type="environment" style="margin-right: 3px"/>新增領洗資料</a>
          </div>
        </div>
            ...
            <div class="box_content_right">
               ...
               <div class="bar">
                  ...
                  <div class="bar">
                    ...
                    <a-input v-if="god == true" class="inputBox" placeholder="請輸入代姓名" v-model="godfather"/>
                    <a-input v-if="god == false" class="inputBox" placeholder="請輸入代姓名" v-model="godmother"/>
                  </div>
                ...
                <div id="phoneUI">
                   <div class="bar">
                    <a-input v-if="god == true" class="inputBox" placeholder="請輸入代父/母姓名" v-model="godfather"/>
                    <a-input v-if="god == false" class="inputBox" placeholder="請輸入代父/母姓名" v-model="godmother"/>
                  </div>
                </div> -->
