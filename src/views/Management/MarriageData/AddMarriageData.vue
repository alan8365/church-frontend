      ...
      >
        <div class="setting">
          <div class="search" id="sear_db">
            <a><a-icon type="environment" style="margin-right: 3px"/>新增結婚資料</a>
          </div>
        </div>
          ...
          <div class="box_content_top">
            ...
            <div class="box_content_right">
                ...
                <div class="bar">
                   ...
                   <div class="searchButton" :style="{ width: scroll_X > 550 ? '70px' : '0px', display : groom_id !== '' ? 'none' : 'block'}"></div>
                   <div class="searchButton" :style="{ width: scroll_X > 550 ? '50px' : '0px', display : groom_id !== '' ? 'block' : 'none'}"></div>
                </div>
                <div class="bar">
                    <a>新郎母親：</a>
                ...
                <div class="bar">
                   ...
                   <div class="searchButton" :style="{ width: scroll_X > 550 ? '70px' : '0px', display : bride_id !== '' ? 'none' : 'block'}"></div>
                    <div class="searchButton" :style="{ width: scroll_X > 550 ? '50px' : '0px', display : bride_id !== '' ? 'block' : 'none'}"></div>
                </div>
                <div class="bar">
                    <a>新娘母親：</a>
...
export default {
  ...
  methods: {
    ...
    ...marriage.mapActions({
      // 新增婚姻資料
      getAddMarriages: 'getAddMarriages',
    }),
    // 上一頁
    forwardup() {
    ...
    // 新增婚姻資料
    addUser() {
      if (this.marriage_at == "" || this.marriage_location == "" || this.presbyter == "" || this.witness1 == "" || this.witness2 == "" || this.groom == "" || this.groom_bornDate == "" || this.bride == "" || this.bride_bornDate == "" ) {
        Modal.warning({
          title: '系統提示',
          content: `請檢查所輸入的資料內容`,
          okText: '確認',
